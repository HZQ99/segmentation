...
if __name__ == "__main__":
    ...
    #   下面只是一个示例
    #--------------------------------------------------#
    model.load_weights("logs/ep016-loss0.242-val_loss0.297.h5")

    #--------------------------------------------------#
    #   对imgs文件夹进行一个遍历
    #--------------------------------------------------#
    imgs = os.listdir("./bochum/")
    for jpg in imgs:
        #--------------------------------------------------#
        #   打开imgs文件夹里面的每一个图片
        #--------------------------------------------------#
        img = Image.open("./bochum/"+jpg)
        ...
        #   将新图片和原图片混合
        #------------------------------------------------#
        image = Image.blend(old_img,seg_img,0.9)
        
        image.save("./bochum_out/"+jpg)
